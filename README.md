...
Before getting started, this project bears codebase from several authors, which [deserve all our respect](/docs/CREDITS.md). Still today, many qualify the Apple II line as the best educational platform available to learn about computer hardware, operating systems, firmware and low-level software development, which this project is trying to demonstrate. So, enjoy the beauty of 8-bit computing on a 6502 CPU, its math tricks and **deceivingly simple** instruction set.
