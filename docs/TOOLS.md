...
The proposed approach here is to select patterns that blend well together.  As a consequence of  patterns are simply too rough, which is a consquence of the .
