...
TODO: this is only a preliminary version, most features associated with color encoding remain to be implemented.  We are waiting for the pattern selector to be working as intended.
