...
<img src="https://raw.githubusercontent.com/RetroAppleJS/AppleII-IDE/main/res/SID_chips.png" align=left width=30% />While emulating AppleII sound is not working out, let's put to work a crazy idea of emulating a C64-style SID chip that could bring us closer to emulating a peripheral that actually did exist for the Apple II: the [Mockingboard](https://en.wikipedia.org/wiki/Mockingboard) sound card. The Mochinboard used the AY-3-8910, a 3-voice sound chip found in the popular MSX, and later ZX Spectrum home computers.  As we speak, I am evaluating a closer match to the AY-3-8910, as this could bring us to real software on the Apple II that was making full use of the mockingboards capabilities.
