...
+"<p><img src=\"https://github.com/RetroAppleJS/RetroAppleJS.github.io/raw/main/res/appleIIplus_bck_650.png?raw=true\" width=39% align=\"left\" />"
+"While the end-user experience with emulators hardly differ from the real hardware, there are some essential deviations, mostly to our benefit, but there are some downsides too.<br></p>"
+"<p><strong>Most basic functions remain the same</strong>  <br>"
+"* the pop-up keyboard toggles SHIFT, CTRL and REPT, enabling key combinations  <br>"
+"* warm boot: press the reset button on the pop-up keyboard  <br>"
+"* cold boot: press the white power button on the pop-up keyboard (originally, this was a flip-switch below the keyboard)   <br>"
+"* insert disk: load any disk file found on the internet (.do, .dsk), after, perform a cold boot   <br>"
+"<em>note: most Apple II disks do not boot, keeping a bootable disk image at hand reach is still required.</em>  </p>"
+"<p><img src=\"https://github.com/RetroAppleJS/RetroAppleJS.github.io/raw/main/res/appleIIplus_kbd_650.png?raw=true\" width=40%/> </p>"
...
+"It produces a Javascript snippet that seamlessly maps the Apple II colors to the different monochrome versions.  This snippet is located in <a href=\"https://github.com/RetroAppleJS/AppleII-IDE/blob/mainhttps://github.com/RetroAppleJS/RetroAppleJS.github.io/raw/main/https://github.com/RetroAppleJS/RetroAppleJS.github.io/raw/main/res/EMU_apple2video.js\">EMU_apple2video.js</a>.</p>"
...
+"<p><img src=\"https://raw.githubusercontent.com/RetroAppleJS/AppleII-IDE/mainhttps://github.com/RetroAppleJS/RetroAppleJS.github.io/raw/main/https://github.com/RetroAppleJS/RetroAppleJS.github.io/raw/main/res/HGRpatternJS.png\" align=left width=50% />This tool is designed to find a color encoding strategy to tackle the typical challenges with Apple II HGR graphics.</p>"
...
+"<p>This small app was designed to examine achievable colors for regular dithering by generating any imaginable bit pattern. Small patches or blocks of pixels, will reveal interesting features in both layers.  Since the color encoding layer has a size of 2x1 bits (wxh), in a full resolution of 280x192, e.g. rendering 4 colors + black and white brings us already down to a color resolution of only 140x192.</p>"
+"<p>Block size 2x2 bits<br>"
+"<img src=\"https://raw.githubusercontent.com/RetroAppleJS/AppleII-IDE/mainhttps://github.com/RetroAppleJS/RetroAppleJS.github.io/raw/main/https://github.com/RetroAppleJS/RetroAppleJS.github.io/raw/main/res/pattern_block_2x2.png\" width=20% align=left /></p>"
+"<p>Block size 4x2 bits<br>"
+"<img src=\"https://raw.githubusercontent.com/RetroAppleJS/AppleII-IDE/mainhttps://github.com/RetroAppleJS/RetroAppleJS.github.io/raw/main/https://github.com/RetroAppleJS/RetroAppleJS.github.io/raw/main/res/pattern_block_4x2.png\" width=20% align=left /></p>"
...
+"<img src=\"https://raw.githubusercontent.com/RetroAppleJS/AppleII-IDE/mainhttps://github.com/RetroAppleJS/RetroAppleJS.github.io/raw/main/https://github.com/RetroAppleJS/RetroAppleJS.github.io/raw/main/res/pattern_block_conflicts_2x2.png\" width=20% align=left /></p>"
+"<p>Color conflics at block size 4x2 bits<br>"
+"<img src=\"https://raw.githubusercontent.com/RetroAppleJS/AppleII-IDE/mainhttps://github.com/RetroAppleJS/RetroAppleJS.github.io/raw/main/https://github.com/RetroAppleJS/RetroAppleJS.github.io/raw/main/res/pattern_block_conflicts_4x2.png\" width=20% align=left /></p>"
