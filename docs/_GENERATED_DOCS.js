DOCS_ZEROPAGE_APPLE2PLUS = "<p>$00-$05 - ???  <br>"
+"  $06-$09 - Free Space  <br>"
...
+"<h3 id=\"a-nameinstr_by_nameainstructions-by-name\">>name=\"INSTR_BY_NAME\"></a>Instructions by Name</h3>"
+"<p><b><div contentEditable=false></b>"
+">href=\"#ADC\" title=\"instruction details for ADC...\">ADC</a>    ….  add with carry  <br>"
+">href=\"#AND\" title=\"instruction details for AND...\">AND</a>    ….  and (with accumulator)  <br>"
+">href=\"#ASL\" title=\"instruction details for ASL...\">ASL</a>    ….  arithmetic shift left  <br>"
+">href=\"#BCC\" title=\"instruction details for BCC...\">BCC</a>    ….  branch on carry clear  <br>"
+">href=\"#BCS\" title=\"instruction details for BCS...\">BCS</a>    ….  branch on carry set  <br>"
+">href=\"#BEQ\" title=\"instruction details for BEQ...\">BEQ</a>    ….  branch on equal (zero set)  <br>"
+">href=\"#BIT\" title=\"instruction details for BIT...\">BIT</a>    ….  bit test  <br>"
+">href=\"#BMI\" title=\"instruction details for BMI...\">BMI</a>    ….    branch on minus (negative set)  <br>"
+">href=\"#BNE\" title=\"instruction details for BNE...\">BNE</a>    ….    branch on not equal (zero clear)  <br>"
+">href=\"#BPL\" title=\"instruction details for BPL...\">BPL</a>    ….    branch on plus (negative clear)  <br>"
+">href=\"#BRK\" title=\"instruction details for BRK...\">BRK</a>    ….    break interrupt  <br>"
+">href=\"#BVC\" title=\"instruction details for BVC...\">BVC</a>    ….    branch on overflow clear  <br>"
+">href=\"#BVS\" title=\"instruction details for BVS...\">BVS</a>    ….    branch on overflow set  <br>"
+">href=\"#CLC\" title=\"instruction details for CLC...\">CLC</a>    ….    clear carry  <br>"
+">href=\"#CLD\" title=\"instruction details for CLD...\">CLD</a>    ….    clear decimal  <br>"
+">href=\"#CLI\" title=\"instruction details for CLI...\">CLI</a>    ….    clear interrupt disable  <br>"
+">href=\"#CLV\" title=\"instruction details for CLV...\">CLV</a>    ….    clear overflow  <br>"
+">href=\"#CMP\" title=\"instruction details for CMP...\">CMP</a>    ….    compare (with accumulator)  <br>"
+">href=\"#CPX\" title=\"instruction details for CPX...\">CPX</a>    ….    compare with X  <br>"
+">href=\"#CPY\" title=\"instruction details for CPY...\">CPY</a>    ….    compare with Y  <br>"
+">href=\"#DEC\" title=\"instruction details for DEC...\">DEC</a>    ….    decrement  <br>"
+">href=\"#DEX\" title=\"instruction details for DEX...\">DEX</a>    ….    decrement X  <br>"
+">href=\"#DEY\" title=\"instruction details for DEY...\">DEY</a>    ….    decrement Y  <br>"
+">href=\"#EOR\" title=\"instruction details for EOR...\">EOR</a>    ….    exclusive or (with accumulator)  <br>"
+">href=\"#INC\" title=\"instruction details for INC...\">INC</a>    ….    increment  <br>"
+">href=\"#INX\" title=\"instruction details for INX...\">INX</a>    ….    increment X  <br>"
+">href=\"#INY\" title=\"instruction details for INY...\">INY</a>    ….    increment Y  <br>"
+">href=\"#JMP\" title=\"instruction details for JMP...\">JMP</a>    ….    jump  <br>"
+">href=\"#JSR\" title=\"instruction details for JSR...\">JSR</a>    ….    jump subroutine  <br>"
+">href=\"#LDA\" title=\"instruction details for LDA...\">LDA</a>    ….    load accumulator  <br>"
+">href=\"#LDX\" title=\"instruction details for LDX...\">LDX</a>    ….    load X  <br>"
+">href=\"#LDY\" title=\"instruction details for LDY...\">LDY</a>    ….    load Y  <br>"
+">href=\"#LSR\" title=\"instruction details for LSR...\">LSR</a>    ….    logical shift right  <br>"
+">href=\"#NOP\" title=\"instruction details for NOP...\">NOP</a>    ….    no operation  <br>"
+">href=\"#ORA\" title=\"instruction details for ORA...\">ORA</a>    ….    or with accumulator  <br>"
+">href=\"#PHA\" title=\"instruction details for PHA...\">PHA</a>    ….    push accumulator  <br>"
+">href=\"#PHP\" title=\"instruction details for PHP...\">PHP</a>    ….    push processor status (SR)  <br>"
+">href=\"#PLA\" title=\"instruction details for PLA...\">PLA</a>    ….    pull accumulator  <br>"
+">href=\"#PLP\" title=\"instruction details for PLP...\">PLP</a>    ….    pull processor status (SR)  <br>"
+">href=\"#ROL\" title=\"instruction details for ROL...\">ROL</a>    ….    rotate left  <br>"
+">href=\"#ROR\" title=\"instruction details for ROR...\">ROR</a>    ….    rotate right  <br>"
+">href=\"#RTI\" title=\"instruction details for RTI...\">RTI</a>    ….    return from interrupt  <br>"
+">href=\"#RTS\" title=\"instruction details for RTS...\">RTS</a>    ….    return from subroutine  <br>"
+">href=\"#SBC\" title=\"instruction details for SBC...\">SBC</a>    ….    subtract with carry  <br>"
+">href=\"#SEC\" title=\"instruction details for SEC...\">SEC</a>    ….    set carry  <br>"
+">href=\"#SED\" title=\"instruction details for SED...\">SED</a>    ….    set decimal  <br>"
+">href=\"#SEI\" title=\"instruction details for SEI...\">SEI</a>    ….    set interrupt disable  <br>"
+">href=\"#STA\" title=\"instruction details for STA...\">STA</a>    ….    store accumulator  <br>"
+">href=\"#STX\" title=\"instruction details for STX...\">STX</a>    ….    store X  <br>"
+">href=\"#STY\" title=\"instruction details for STY...\">STY</a>    ….    store Y  <br>"
+">href=\"#TAX\" title=\"instruction details for TAX...\">TAX</a>    ….    transfer accumulator to X  <br>"
+">href=\"#TAY\" title=\"instruction details for TAY...\">TAY</a>    ….    transfer accumulator to Y  <br>"
+">href=\"#TSX\" title=\"instruction details for TSX...\">TSX</a>    ….    transfer stack pointer to X  <br>"
+">href=\"#TXA\" title=\"instruction details for TXA...\">TXA</a>    ….    transfer X to accumulator  <br>"
+">href=\"#TXS\" title=\"instruction details for TXS...\">TXS</a>    ….    transfer X to stack pointer  <br>"
+">href=\"#TYA\" title=\"instruction details for TYA...\">TYA</a>    ….    transfer Y to accumulator  <br>"
+"</div></p>"
...
+"<img style=\"-webkit-filter: invert(1) sepia(0.75) brightness(0.75) hue-rotate(110deg) brightness(1.3);filter: invert(1) sepia(0.75) brightness(0.75) hue-rotate(110deg) brightness(1.3);\" src=\"res/MOS_6502AD_300px.png\" alt=\"MOS Techology 6502 MPU\" title=\"MOS Techology 6502 MPU\" /></p>"
...
+"<h3 id=\"a-nameadcaadc---add-memory-to-accumulator-with-carry---topinstr_by_name-instructions-by-name\">>name=\"ADC\"></a>ADC - Add Memory to Accumulator with Carry - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-nameandaand---and-memory-with-accumulator---topinstr_by_name-instructions-by-name\">>name=\"AND\"></a>AND - AND Memory with Accumulator - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-nameaslaasl---shift-left-one-bit-memory-or-accumulator---topinstr_by_name-instructions-by-name\">>name=\"ASL\"></a>ASL - Shift Left One Bit (Memory or Accumulator) - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-namebccabcc---branch-on-carry-clear---topinstr_by_name-instructions-by-name\">>name=\"BCC\"></a>BCC - Branch on Carry Clear - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-namebcsabcs---branch-on-carry-set---topinstr_by_name-instructions-by-name\">>name=\"BCS\"></a>BCS - Branch on Carry Set - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-namebeqabeq---branch-on-result-zero---topinstr_by_name-instructions-by-name\">>name=\"BEQ\"></a>BEQ - Branch on Result Zero - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-namebitabit---test-bits-in-memory-with-accumulator---topinstr_by_name-instructions-by-name\">>name=\"BIT\"></a>BIT - Test Bits in Memory with Accumulator - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-namebmiabmi---branch-on-result-minus---topinstr_by_name-instructions-by-name\">>name=\"BMI\"></a>BMI - Branch on Result Minus - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-namebneabne---branch-on-result-not-zero---topinstr_by_name-instructions-by-name\">>name=\"BNE\"></a>BNE - Branch on Result not Zero - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-namebplabpl---branch-on-result-plus---topinstr_by_name-instructions-by-name\">>name=\"BPL\"></a>BPL - Branch on Result Plus - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-namebrkabrk---force-break---topinstr_by_name-instructions-by-name\">>name=\"BRK\"></a>BRK - Force Break - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-namebvcabvc---branch-on-overflow-clear---topinstr_by_name-instructions-by-name\">>name=\"BVC\"></a>BVC - Branch on Overflow Clear - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-namebvsabvs---branch-on-overflow-set---topinstr_by_name-instructions-by-name\">>name=\"BVS\"></a>BVS - Branch on Overflow Set - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-nameclcaclc---clear-carry-flag---topinstr_by_name-instructions-by-name\">>name=\"CLC\"></a>CLC - Clear Carry Flag - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-namecldacld---clear-decimal-mode---topinstr_by_name-instructions-by-name\">>name=\"CLD\"></a>CLD - Clear Decimal Mode - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-namecliacli---clear-interrupt-disable-bit---topinstr_by_name-instructions-by-name\">>name=\"CLI\"></a>CLI - Clear Interrupt Disable Bit - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-nameclvaclv---clear-overflow-flag---topinstr_by_name-instructions-by-name\">>name=\"CLV\"></a>CLV - Clear Overflow Flag - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-namecmpacmp---compare-memory-with-accumulator---topinstr_by_name-instructions-by-name\">>name=\"CMP\"></a>CMP - Compare Memory with Accumulator - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-namecpxacpx---compare-memory-and-index-x---topinstr_by_name-instructions-by-name\">>name=\"CPX\"></a>CPX - Compare Memory and Index X - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-namecpyacpy---compare-memory-and-index-y---topinstr_by_name-instructions-by-name\">>name=\"CPY\"></a>CPY - Compare Memory and Index Y - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-namedecadec---decrement-memory-by-one---topinstr_by_name-instructions-by-name\">>name=\"DEC\"></a>DEC - Decrement Memory by One - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-namedexadex---decrement-index-x-by-one---topinstr_by_name-instructions-by-name\">>name=\"DEX\"></a>DEX - Decrement Index X by One - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-namedeyadey---decrement-index-y-by-one---topinstr_by_name-instructions-by-name\">>name=\"DEY\"></a>DEY - Decrement Index Y by One - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-nameeoraeor---exclusive-or-memory-with-accumulator---topinstr_by_name-instructions-by-name\">>name=\"EOR\"></a>EOR - Exclusive-OR Memory with Accumulator - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-nameincainc---increment-memory-by-one---topinstr_by_name-instructions-by-name\">>name=\"INC\"></a>INC - Increment Memory by One - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
+"<pre><code> M + 1 -> M                       N Z C I D V<br>"
+"                                  + + - - - -<br>"
+"<br>"
+" addressing    assembler    opc  bytes  cyles<br>"
...
+"<h3 id=\"a-nameinxainx---increment-index-x-by-one---topinstr_by_name-instructions-by-name\">>name=\"INX\"></a>INX - Increment Index X by One - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
+"<pre><code> X + 1 -> X                       N Z C I D V<br>"
+"                                  + + - - - -<br>"
+"<br>"
+" addressing    assembler    opc  bytes  cyles<br>"
...
+"<h3 id=\"a-nameinyainy---increment-index-y-by-one---topinstr_by_name-instructions-by-name\">>name=\"INY\"></a>INY - Increment Index Y by One - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
+"<pre><code> Y + 1 -> Y                       N Z C I D V<br>"
+"                                  + + - - - -<br>"
+"<br>"
+" addressing    assembler    opc  bytes  cyles<br>"
...
+"<h3 id=\"a-namejmpajmp---jump-to-new-location---topinstr_by_name-instructions-by-name\">>name=\"JMP\"></a>JMP - Jump to New Location - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-namejsrajsr---jump-to-new-location-saving-return-address---topinstr_by_name-instructions-by-name\">>name=\"JSR\"></a>JSR - Jump to New Location Saving Return Address - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-nameldaalda---load-accumulator-with-memory---topinstr_by_name-instructions-by-name\">>name=\"LDA\"></a>LDA - Load Accumulator with Memory - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-nameldxaldx---load-index-x-with-memory---topinstr_by_name-instructions-by-name\">>name=\"LDX\"></a>LDX - Load Index X with Memory - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-nameldyaldy---load-index-y-with-memory---topinstr_by_name-instructions-by-name\">>name=\"LDY\"></a>LDY - Load Index Y with Memory - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-namelsralsr---shift-one-bit-right-memory-or-accumulator---topinstr_by_name-instructions-by-name\">>name=\"LSR\"></a>LSR - Shift One Bit Right (Memory or Accumulator) - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-namenopanop---no-operation---topinstr_by_name-instructions-by-name\">>name=\"NOP\"></a>NOP - No Operation - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-nameoraaora---or-memory-with-accumulator---topinstr_by_name-instructions-by-name\">>name=\"ORA\"></a>ORA - OR Memory with Accumulator - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-namephaapha---push-accumulator-on-stack---topinstr_by_name-instructions-by-name\">>name=\"PHA\"></a>PHA - Push Accumulator on Stack - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-namephpaphp---push-processor-status-on-stack---topinstr_by_name-instructions-by-name\">>name=\"PHP\"></a>PHP - Push Processor Status on Stack - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-nameplaapla---pull-accumulator-from-stack---topinstr_by_name-instructions-by-name\">>name=\"PLA\"></a>PLA - Pull Accumulator from Stack - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-nameplpaplp---pull-processor-status-from-stack---topinstr_by_name-instructions-by-name\">>name=\"PLP\"></a>PLP - Pull Processor Status from Stack - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-namerolarol---rotate-one-bit-left-memory-or-accumulator---topinstr_by_name-instructions-by-name\">>name=\"ROL\"></a>ROL - Rotate One Bit Left (Memory or Accumulator) - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-nameroraror---rotate-one-bit-right-memory-or-accumulator---topinstr_by_name-instructions-by-name\">>name=\"ROR\"></a>ROR - Rotate One Bit Right (Memory or Accumulator) - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
+"<pre><code> C -> \[76543210\] -> C             N Z C I D V<br>"
+"                                  + + + - - -<br>"
+"<br>"
+" addressing    assembler    opc  bytes  cyles<br>"
...
+"<h3 id=\"a-namertiarti---return-from-interrupt---topinstr_by_name-instructions-by-name\">>name=\"RTI\"></a>RTI - Return from Interrupt - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-namertsarts---return-from-subroutine---topinstr_by_name-instructions-by-name\">>name=\"RTS\"></a>RTS - Return from Subroutine - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-namesbcasbc---subtract-memory-from-accumulator-with-borrow---topinstr_by_name-instructions-by-name\">>name=\"SBC\"></a>SBC - Subtract Memory from Accumulator with Borrow - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-namesecasec---set-carry-flag---topinstr_by_name-instructions-by-name\">>name=\"SEC\"></a>SEC - Set Carry Flag - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-namesedased---set-decimal-flag---topinstr_by_name-instructions-by-name\">>name=\"SED\"></a>SED - Set Decimal Flag - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-nameseiasei---set-interrupt-disable-status---topinstr_by_name-instructions-by-name\">>name=\"SEI\"></a>SEI - Set Interrupt Disable Status - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-namestaasta---store-accumulator-in-memory---topinstr_by_name-instructions-by-name\">>name=\"STA\"></a>STA - Store Accumulator in Memory - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
+"<pre><code> A -> M                           N Z C I D V<br>"
+"                                  - - - - - -<br>"
+"<br>"
+" addressing    assembler    opc  bytes  cyles<br>"
...
+"<h3 id=\"a-namestxastx---store-index-x-in-memory---topinstr_by_name-instructions-by-name\">>name=\"STX\"></a>STX - Store Index X in Memory - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
+"<pre><code> X -> M                           N Z C I D V<br>"
+"                                  - - - - - -<br>"
+"<br>"
+" addressing    assembler    opc  bytes  cyles<br>"
...
+"<h3 id=\"a-namestyasty---sore-index-y-in-memory---topinstr_by_name-instructions-by-name\">>name=\"STY\"></a>STY - Sore Index Y in Memory - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
+"<pre><code> Y -> M                           N Z C I D V<br>"
+"                                  - - - - - -<br>"
+"<br>"
+" addressing    assembler    opc  bytes  cyles<br>"
...
+"<h3 id=\"a-nametaxatax---transfer-accumulator-to-index-x---topinstr_by_name-instructions-by-name\">>name=\"TAX\"></a>TAX - Transfer Accumulator to Index X - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-nametayatay---transfer-accumulator-to-index-y---topinstr_by_name-instructions-by-name\">>name=\"TAY\"></a>TAY - Transfer Accumulator to Index Y - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-nametsxatsx---transfer-stack-pointer-to-index-x---topinstr_by_name-instructions-by-name\">>name=\"TSX\"></a>TSX - Transfer Stack Pointer to Index X - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-nametxaatxa---transfer-index-x-to-accumulator---topinstr_by_name-instructions-by-name\">>name=\"TXA\"></a>TXA - Transfer Index X to Accumulator - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-nametxsatxs---transfer-index-x-to-stack-register---topinstr_by_name-instructions-by-name\">>name=\"TXS\"></a>TXS - Transfer Index X to Stack Register - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<h3 id=\"a-nametyaatya---transfer-index-y-to-accumulator---topinstr_by_name-instructions-by-name\">>name=\"TYA\"></a>TYA - Transfer Index Y to Accumulator - >href=\"#INSTR_BY_NAME\" title=\"instructions by name\">top</a></h3>"
...
+"<p><img style=\"-webkit-filter: invert(1) sepia(0.75) brightness(0.75) hue-rotate(110deg) brightness(1.3);filter: invert(1) sepia(0.75) brightness(0.75) hue-rotate(110deg) brightness(1.3);\" src=\"res/mcs6502-interrupt-ops_340.gif\" alt=\"6502 Interrupt Operations\" style=\"-webkit-filter: invert(1) sepia(0.75) brightness(0.75) hue-rotate(110deg) brightness(1.3);filter: invert(1) sepia(0.75) brightness(0.75) hue-rotate(110deg) brightness(1.3);\" />  </p>"
...
+"<p><img style=\"-webkit-filter: invert(1) sepia(0.75) brightness(0.75) hue-rotate(110deg) brightness(1.3);filter: invert(1) sepia(0.75) brightness(0.75) hue-rotate(110deg) brightness(1.3);\" src=\"res/mcs6502-jsr-rts-ops.png\" alt=\"6502 Subroutine Operations\" /></p>"
+"<p>(Image: MCS6502 Instruction Set Summary, MOS Technology, Inc.)</p>"

DOCS_DEBUGGER = "<h2 id=\"debugger-instructions\">DEBUGGER Instructions</h2><hr>"
...
DOCS_ASSEMBLER = "<h2 id=\"assembler-instructions\">ASSEMBLER Instructions</h2><hr>"
