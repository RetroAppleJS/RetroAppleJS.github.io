...
+"[ADC](#ADC \"instruction details for ADC...\")    ....  add with carry  <br>"
+"[AND](#AND \"instruction details for AND...\")    ....  and (with accumulator)  <br>"
+"[ASL](#ASL \"instruction details for ASL...\")    ....  arithmetic shift left  <br>"
+"[BCC](#BCC \"instruction details for BCC...\")    ....  branch on carry clear  <br>"
+"[BCS](#BCS \"instruction details for BCS...\")    ....  branch on carry set  <br>"
+"[BEQ](#BEQ \"instruction details for BEQ...\")    ....  branch on equal (zero set)  <br>"
+"[BIT](#BIT \"instruction details for BIT...\")    ....  bit test  <br>"
+"[BMI](#BMI \"instruction details for BMI...\")    ....    branch on minus (negative set)  <br>"
+"[BNE](#BNE \"instruction details for BNE...\")    ....    branch on not equal (zero clear)  <br>"
+"[BPL](#BPL \"instruction details for BPL...\")    ....    branch on plus (negative clear)  <br>"
+"[BRK](#BRK \"instruction details for BRK...\")    ....    break / interrupt  <br>"
+"[BVC](#BVC \"instruction details for BVC...\")    ....    branch on overflow clear  <br>"
+"[BVS](#BVS \"instruction details for BVS...\")    ....    branch on overflow set  <br>"
+"[CLC](#CLC \"instruction details for CLC...\")    ....    clear carry  <br>"
+"[CLD](#CLD \"instruction details for CLD...\")    ....    clear decimal  <br>"
+"[CLI](#CLI \"instruction details for CLI...\")    ....    clear interrupt disable  <br>"
+"[CLV](#CLV \"instruction details for CLV...\")    ....    clear overflow  <br>"
+"[CMP](#CMP \"instruction details for CMP...\")    ....    compare (with accumulator)  <br>"
+"[CPX](#CPX \"instruction details for CPX...\")    ....    compare with X  <br>"
+"[CPY](#CPY \"instruction details for CPY...\")    ....    compare with Y  <br>"
+"[DEC](#DEC \"instruction details for DEC...\")    ....    decrement  <br>"
+"[DEX](#DEX \"instruction details for DEX...\")    ....    decrement X  <br>"
+"[DEY](#DEY \"instruction details for DEY...\")    ....    decrement Y  <br>"
+"[EOR](#EOR \"instruction details for EOR...\")    ....    exclusive or (with accumulator)  <br>"
+"[INC](#INC \"instruction details for INC...\")    ....    increment  <br>"
+"[INX](#INX \"instruction details for INX...\")    ....    increment X  <br>"
+"[INY](#INY \"instruction details for INY...\")    ....    increment Y  <br>"
+"[JMP](#JMP \"instruction details for JMP...\")    ....    jump  <br>"
+"[JSR](#JSR \"instruction details for JSR...\")    ....    jump subroutine  <br>"
+"[LDA](#LDA \"instruction details for LDA...\")    ....    load accumulator  <br>"
+"[LDX](#LDX \"instruction details for LDX...\")    ....    load X  <br>"
+"[LDY](#LDY \"instruction details for LDY...\")    ....    load Y  <br>"
+"[LSR](#LSR \"instruction details for LSR...\")    ....    logical shift right  <br>"
+"[NOP](#NOP \"instruction details for NOP...\")    ....    no operation  <br>"
+"[ORA](#ORA \"instruction details for ORA...\")    ....    or with accumulator  <br>"
+"[PHA](#PHA \"instruction details for PHA...\")    ....    push accumulator  <br>"
+"[PHP](#PHP \"instruction details for PHP...\")    ....    push processor status (SR)  <br>"
+"[PLA](#PLA \"instruction details for PLA...\")    ....    pull accumulator  <br>"
+"[PLP](#PLP \"instruction details for PLP...\")    ....    pull processor status (SR)  <br>"
+"[ROL](#ROL \"instruction details for ROL...\")    ....    rotate left  <br>"
+"[ROR](#ROR \"instruction details for ROR...\")    ....    rotate right  <br>"
+"[RTI](#RTI \"instruction details for RTI...\")    ....    return from interrupt  <br>"
+"[RTS](#RTS \"instruction details for RTS...\")    ....    return from subroutine  <br>"
+"[SBC](#SBC \"instruction details for SBC...\")    ....    subtract with carry  <br>"
+"[SEC](#SEC \"instruction details for SEC...\")    ....    set carry  <br>"
+"[SED](#SED \"instruction details for SED...\")    ....    set decimal  <br>"
+"[SEI](#SEI \"instruction details for SEI...\")    ....    set interrupt disable  <br>"
+"[STA](#STA \"instruction details for STA...\")    ....    store accumulator  <br>"
+"[STX](#STX \"instruction details for STX...\")    ....    store X  <br>"
+"[STY](#STY \"instruction details for STY...\")    ....    store Y  <br>"
+"[TAX](#TAX \"instruction details for TAX...\")    ....    transfer accumulator to X  <br>"
+"[TAY](#TAY \"instruction details for TAY...\")    ....    transfer accumulator to Y  <br>"
+"[TSX](#TSX \"instruction details for TSX...\")    ....    transfer stack pointer to X  <br>"
+"[TXA](#TXA \"instruction details for TXA...\")    ....    transfer X to accumulator  <br>"
+"[TXS](#TXS \"instruction details for TXS...\")    ....    transfer X to stack pointer  <br>"
+"[TYA](#TYA \"instruction details for TYA...\")    ....    transfer Y to accumulator  <br>"
+"</div>"
...
+"<img src=\"res/MOS_6502AD_300px.png\" alt=\"MOS Techology 6502 MPU\" title=\"MOS Techology 6502 MPU\" /></p>"
...
+"<p><img src=\"res/mcs6502-interrupt-ops.png\" alt=\"6502 Interrupt Operations\" /></p>"
