            ...
            +"<div class=marginless style='border:0'>"
                ...
                +"<div style='font-family:Arial,sans-serif;font-size:10px;line-height:18px;margin-top:3px'>"
                    +"<div style='white-space:nowrap'>"
                        +"<label><input id='cpuDbg_followPc' type='checkbox' checked onchange='oEMU.component.CPU.Apple2Debug.setFollowPC(this.checked)'> Track PC</label>"
                        +"&nbsp;NAV "
                        ...
                        +"<button type='button' title='Return to live PC and resume tracking' onclick='oEMU.component.CPU.Apple2Debug.setFollowPC(true)' style='font-size:10px'>PC</button>"
                        +"<span id='cpuDbg_navStatus' style='margin-left:4px;font-family:"+listingFontFamily+"'></span>"
                    +"</div>"
