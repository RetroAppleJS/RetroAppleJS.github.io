...
+"<ol>"
+"<li><p>In the emulator, use <strong>MemCap</strong> to capture the full memory space.</p></li>"
+"<li><p>Copy the memory capture.</p></li>"
+"<li><p>Go to the Debugger tab.</p></li>"
+"<li><p>Open the <strong>Tools</strong> section.</p></li>"
+"<li><p>Paste the memory capture into the memory input area.</p></li>"
+"<li><p>Load or paste a matching symbol file if available.</p></li>"
+"<li><p>Set or verify the start address / Program Counter.</p></li>"
+"<li><p>Start stepping.</p>"
+"<p>┌──────────────────────┐<br>"
+"  │ Running emulator     │<br>"
+"  │ full 64K memory      │<br>"
+"  └──────────┬───────────┘<br>"
