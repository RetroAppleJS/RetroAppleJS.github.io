...
,"upper(_3_)":{"REGXEP_INPUT":"( [abcdeijlnoprst][abcdehijlmnoprstv][acdeiklpqrstvxy] )" ,"REGEXP_OUTPUT":"x.toUpperCase()"}
,"upper(_3)":{"REGXEP_INPUT":"( [abcdeijlnoprst][abcdehijlmnoprstv][acdeiklpqrstvxy])$" ,"REGEXP_OUTPUT":"x.toUpperCase()"}
,"upper(3_)":{"REGXEP_INPUT":"^([abcdeijlnoprst][abcdehijlmnoprstv][acdeiklpqrstvxy] )" ,"REGEXP_OUTPUT":"x.toUpperCase()"}
,"upper(3)":{"REGXEP_INPUT":"^([abcdeijlnoprst][abcdehijlmnoprstv][acdeiklpqrstvxy])$" ,"REGEXP_OUTPUT":"x.toUpperCase()"}
}
