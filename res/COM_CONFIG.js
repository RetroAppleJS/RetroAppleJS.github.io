...
,".fill":{"COMPILER":"SourceGen" ,"REGXEP_INPUT":"\\.fill\\x20|\\.FILL\\x20([\\s\\S]*)$" ,"REGEXP_OUTPUT":"'HEX'+x.split(',')[1].replace(/ /g,'').replace(/\\$/g,' ').toUpperCase().repeat(x.split(',')[0].replace(/[^0-9]/g,''))+' '" ,"DESCRIPTION":"Substitute .fill by HEX array"}
