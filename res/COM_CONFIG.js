...
const _CFG_TFUNCTION = {
 ".eq":{"COMPILER":"SourceGen" ,"REGXEP_INPUT":"\\x20\\.eq|.EQ\\x20" ,"REGEXP_OUTPUT":"'EQU'"}
,".var":{"COMPILER":"SourceGen" ,"REGXEP_INPUT":"\\x20\\.var\\x20" ,"REGEXP_OUTPUT":"'EQU'"}
,".org":{"COMPILER":"SourceGen" ,"REGXEP_INPUT":"\\x20\\.org\\x20" ,"REGEXP_OUTPUT":"'ORG'"}
,".str":{"COMPILER":"SourceGen" ,"REGXEP_INPUT":"\\x20\\.str\\x20" ,"REGEXP_OUTPUT":"'ASC'"}
