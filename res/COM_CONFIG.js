...
+"<br>"
+"<img src=\"https://github.com/RetroAppleJS/RetroAppleJS.github.io/raw/main/res/doc_emu_system_pane.png?raw=true\" width=10%  align=\"left\"/> On the emulator's system pane, the colour pallet button allows cycling through colour modes (colour, black & white, green, amber). This button is handy wherever the Apple II colour encoding becomes disturbing (e.g. font display in HGR graphics). Please find coding documentation about \"color mode\" here <a href=\"EMULATOR_DEV.md\">EMULATOR_DEV.md</a></p>"
+"<p><br></p>"
