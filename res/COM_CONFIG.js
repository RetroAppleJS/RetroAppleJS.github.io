...
,".fill":{"COMPILER":"SourceGen" ,"REGXEP_INPUT":"'HEX'+x.split(',')[1].replace(/ /g,'').replace(/\\$/g,' ').toUpperCase().repeat(x.split(',')[0].replace(/[^0-9]/g,''))+' '" ,"REGEXP_OUTPUT":"x.split(',')[0]" ,"DESCRIPTION":"Substitute .fill by HEX array"}
