...
const _CFG_TFUNCTION = {
 ".eq":{"REGXEP_INPUT":"\\x20\\.eq\\x20" ,"REGEXP_OUTPUT":"'EQU'"}
,".var":{"REGXEP_INPUT":"\\x20\\.var\\x20" ,"REGEXP_OUTPUT":"'EQU'"}
,".org":{"REGXEP_INPUT":"\\x20\\.org\\x20" ,"REGEXP_OUTPUT":"'ORG'"}
,"remove{*}":{"REGXEP_INPUT":"\\{[^{}]*\\}" ,"REGEXP_OUTPUT":"''"}
,"upper(_3_)":{"REGXEP_INPUT":"( [abcdeijlnoprst][abcdehijlmnoprstvxy][acdeiklpqrstvxy] )" ,"REGEXP_OUTPUT":"x.toUpperCase()"}
,"upper(_3)":{"REGXEP_INPUT":"( [abcdeijlnoprst][abcdehijlmnoprstvxy][acdeiklpqrstvxy])$" ,"REGEXP_OUTPUT":"x.toUpperCase()"}
,"upper(3_)":{"REGXEP_INPUT":"^([abcdeijlnoprst][abcdehijlmnoprstvxy][acdeiklpqrstvxy] )" ,"REGEXP_OUTPUT":"x.toUpperCase()"}
,"upper(3)":{"REGXEP_INPUT":"^([abcdeijlnoprst][abcdehijlmnoprstvxy][acdeiklpqrstvxy])$" ,"REGEXP_OUTPUT":"x.toUpperCase()"}
,"hex array":{"REGXEP_INPUT":"\\$([0-9A-Fa-f][0-9A-Fa-f][, ])" ,"REGEXP_OUTPUT":"x.substring(1,3).toUpperCase()+' '"}
,".bulk":{"REGXEP_INPUT":"\\x20\\.bulk\\x20" ,"REGEXP_OUTPUT":"'HEX'"}
,"+":{"REGXEP_INPUT":"\\x20\\+\\x20\\x20\\x20" ,"REGEXP_OUTPUT":"'HEX'"}
,".str":{"REGXEP_INPUT":"\\x20\\.str\\x20" ,"REGEXP_OUTPUT":"'ASC'"}
,"*":{"REGXEP_INPUT":"^\\*" ,"REGEXP_OUTPUT":"';*'"}
}
