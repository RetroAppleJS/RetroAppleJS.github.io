...
+"<br>"
+"<img src=\"https://github.com/RetroAppleJS/RetroAppleJS.github.io/raw/main/res/doc_emu_system_pane.png?raw=true\" width=10%  align=\"left\"/> On the emulators system pane, the color pallet button allows cycling through color modes (color, black&white, green, amber).  This button comes in handy wherever the Apple II color encoding becomes disturbing (e.g. font display in HGR graphics).<br>"
+"Please find coding documentation about \"color mode\" here <a href=\"EMULATOR_DEV.md\">EMULATOR_DEV.md</a></p>"
+"<p><br></p>"
