...
function Apple2Video(ctx)
{
    ...
    this.reset = function() {
        ...
        if(vidContext === undefined)
        {
            ...
            doDraw = () => 
            {
                kernel(apple2plus.hwObj().safe_flashdump(),apple2CharRom,apple2plus.vidObj().GPU_CFG);
