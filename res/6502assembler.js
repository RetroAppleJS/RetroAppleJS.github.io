...
function s_doPass(pass)
{
	...
	else
	{
		...
		else if (mactab != null) // MACRO CODE
		{
			...
			{
				case "HEX":
					//var arg = sym.slice(1,sym.length).join('').replace(/ /g,"");
					var arg = sym.slice(ofs + 1, sym.length).join(" ")
					//var arg = sym[ofs+1].replace(/ /g,"");
				...
				case "ASC":
					//var str = sym.slice(1,sym.length).join(" ");
