...
function AppleLiron()
{
    ...
    this.deviceToolSurfaceMapSetPage = function(page)
    {
        ...
        if(geometry && Number.isInteger(geometry.pageCount)) maxPage=Math.max(0,geometry.pageCount-1);
