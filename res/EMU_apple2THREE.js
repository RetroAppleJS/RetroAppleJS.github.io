...
var APPLE2_THREE_CFG_DEFAULT = 
{
    ...
    function Apple2VideoTHREE_controls(renderer3D)
    {
        ...
        return "<div class=\"appbut mini\">"
            ...
            +"<button type=\"button\" class=\"appbut mini\" onclick=\"Apple2VideoTHREE_resetCameraControl()\">reset camera</button>";           
    }
    ...
    function Apple2VideoTHREE(canvas)
    {
        ...
        {
            return this.camera && this.camera.isPerspectiveCamera ? this.camera.fov : 30;
        };
