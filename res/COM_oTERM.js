...
function TERMINAL(props) 
{
  ...
  function isolateTerminalKeyboard(event)
  {
    event.stopPropagation();
  }

  this._o.DOM.input.addEventListener("keydown", isolateTerminalKeyboard, true);
  this._o.DOM.input.addEventListener("keyup", isolateTerminalKeyboard, true);
  this._o.DOM.input.addEventListener("keypress", isolateTerminalKeyboard, true);
