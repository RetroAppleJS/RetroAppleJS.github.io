...
function col80card()
{
    ...
    this.io    =        // TODO: check how much memory this.io occupies (replace function pointer by hash of the peripheral + slotID ? - I'm afraid these pointers take too much space)
    { 
        "SlotROM":{  "RD":{"callback":readROM.bind(this)}}                              // by default always 256 bytes
