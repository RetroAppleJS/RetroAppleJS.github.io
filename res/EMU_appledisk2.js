    ...
    this.read = function(addr) 
    {
        ...
        if (addr < 0x08) {
            ...
            case Q6L:
                ...
                {
                    if (++this.state.hw[drv].offset == TRACK_SIZE) this.state.hw[drv].offset = 0;                   
                    ...
                    if (this.state.hw[drv].q7)
                    {
                        ...
                        if(bDebug) console.log("disk2.read() Q6L write "+this.state.hw[drv].data_latch+" to [D"+drv+"][loc:"+loc+"]  state.hw="+JSON.stringify(this.state.hw));
                        return this.state.hw[drv].data_latch;
                    }
                    else
                    {
                        // Read from disk.
                        if(bDebug) console.log("disk2.read() Q6L read "+this.state.diskData[drv][loc]+" from [D"+drv+"][loc:"+loc+"]  state.hw="+JSON.stringify(this.state.hw));
