    ...
    this.read = function(addr) 
    {
        ...
        if (addr < 0x08) 
        {
            ...
            if ((addr & 1) != 0) {
                ...
                if (((this.state.hw[drv].phase + 1) & 3) == p) {
                    // Ascending order, track arm moves inward.
                    this.state.hw[drv].phase = p;
                    this.update_logs("phase");
                    if ((this.state.hw[drv].phase & 1) == 0)
                    {
                        var oldTrack = this.state.hw[drv].track;
                        if (++this.state.hw[drv].track >= 35)
                        {
                            this.state.hw[drv].track = 35; // CLICK! CLICK! CLICK!
                            this.dN_update("CLICK_OUT");
                            this.traceArmStep(drv, "CLICK_OUT", oldTrack, this.state.hw[drv].track);
                        }
                        else
                        {
                ...
                else if (((this.state.hw[drv].phase - 1) & 3) == p) 
                {
                    ...
                    {
                        var oldTrack = this.state.hw[drv].track;
                        if (--this.state.hw[drv].track < 0)
                        {
                            this.state.hw[drv].track = 0; // CLICK! CLICK! CLICK!
                            this.dN_update("CLICK_IN");
                            this.traceArmStep(drv, "CLICK_IN", oldTrack, this.state.hw[drv].track);
                        }
                        else
                        {
            ...
            case Q6L:
                ...
                if (oldQ6 != 0)
                    this.traceChange("Q6L_STROBE_DATA_LATCH", drv, "q6", oldQ6, 0);

                // Strobe Data Latch for I/O
                if (!this.state.diskData[drv])
                {
                    this.traceUnavailable(drv, "diskData=null");
                    return 0xff;
                }

                if (!this.state.hw[drv].motor)
                {
                    this.traceUnavailable(drv, "motor=0");
                    return 0xff;
                }

                this.trace.lastUnavailable = "";

                if (++this.state.hw[drv].offset == TRACK_SIZE)
                    this.state.hw[drv].offset = 0;

                var loc = this.state.hw[drv].track * TRACK_SIZE + this.state.hw[drv].offset;
...
*/
   ...
   this.ROM = new Uint8Array([ // P5A
    ...
    this.traceLog = function(eventName, data)
    {
        ...
        data = data || {};
        var drv = data.drv;
        if (drv === undefined) drv = this.state.drv;
        var hw = this.state.hw[drv] || {};
    ...
    this.GitHubDirCache = {"https://api.github.com/repos/RetroAppleJS/RetroAppleJS.github.io/contents/disks?ref=main":{"list":[{"name":"Apple DOS 3.3.dsk","path":"disks/Apple DOS 3.3.dsk","type":"file","size":143360,"download_url":"https://raw.githubusercontent.com/RetroAppleJS/RetroAppleJS.github.io/main/disks/Apple%20DOS%203.3.dsk","html_url":"https://github.com/RetroAppleJS/RetroAppleJS.github.io/blob/main/disks/Apple%20DOS%203.3.dsk"},{"name":"BLANK_DOS.DSK","path":"disks/BLANK_DOS.DSK","type":"file","size":143360,"download_url":"https://raw.githubusercontent.com/RetroAppleJS/RetroAppleJS.github.io/main/disks/BLANK_DOS.DSK","html_url":"https://github.com/RetroAppleJS/RetroAppleJS.github.io/blob/main/disks/BLANK_DOS.DSK"},{"name":"BLANK_PRONTODOS.dsk","path":"disks/BLANK_PRONTODOS.dsk","type":"file","size":143360,"download_url":"https://raw.githubusercontent.com/RetroAppleJS/RetroAppleJS.github.io/main/disks/BLANK_PRONTODOS.dsk","html_url":"https://github.com/RetroAppleJS/RetroAppleJS.github.io/blob/main/disks/BLANK_PRONTODOS.dsk"},{"name":"Conan 1984-Disk1-1-Side A.dsk","path":"disks/Conan 1984-Disk1-1-Side A.dsk","type":"file","size":143360,"download_url":"https://raw.githubusercontent.com/RetroAppleJS/RetroAppleJS.github.io/main/disks/Conan%201984-Disk1-1-Side%20A.dsk","html_url":"https://github.com/RetroAppleJS/RetroAppleJS.github.io/blob/main/disks/Conan%201984-Disk1-1-Side%20A.dsk"},{"name":"Conan 1984-Disk1-1-Side B.dsk","path":"disks/Conan 1984-Disk1-1-Side B.dsk","type":"file","size":143360,"download_url":"https://raw.githubusercontent.com/RetroAppleJS/RetroAppleJS.github.io/main/disks/Conan%201984-Disk1-1-Side%20B.dsk","html_url":"https://github.com/RetroAppleJS/RetroAppleJS.github.io/blob/main/disks/Conan%201984-Disk1-1-Side%20B.dsk"},{"name":"Falcons.dsk","path":"disks/Falcons.dsk","type":"file","size":143360,"download_url":"https://raw.githubusercontent.com/RetroAppleJS/RetroAppleJS.github.io/main/disks/Falcons.dsk","html_url":"https://github.com/RetroAppleJS/RetroAppleJS.github.io/blob/main/disks/Falcons.dsk"},{"name":"Merlin","path":"disks/Merlin","type":"dir","size":0,"download_url":null,"html_url":"https://github.com/RetroAppleJS/RetroAppleJS.github.io/tree/main/disks/Merlin"},{"name":"PacMan_collection.dsk","path":"disks/PacMan_collection.dsk","type":"file","size":143360,"download_url":"https://raw.githubusercontent.com/RetroAppleJS/RetroAppleJS.github.io/main/disks/PacMan_collection.dsk","html_url":"https://github.com/RetroAppleJS/RetroAppleJS.github.io/blob/main/disks/PacMan_collection.dsk"},{"name":"ProDOS_2_5_a8_143k.dsk","path":"disks/ProDOS_2_5_a8_143k.dsk","type":"file","size":143360,"download_url":"https://raw.githubusercontent.com/RetroAppleJS/RetroAppleJS.github.io/main/disks/ProDOS_2_5_a8_143k.dsk","html_url":"https://github.com/RetroAppleJS/RetroAppleJS.github.io/blob/main/disks/ProDOS_2_5_a8_143k.dsk"},{"name":"Saturn-RAMSoft","path":"disks/Saturn-RAMSoft","type":"dir","size":0,"download_url":null,"html_url":"https://github.com/RetroAppleJS/RetroAppleJS.github.io/tree/main/disks/Saturn-RAMSoft"},{"name":"dev toolkits","path":"disks/dev toolkits","type":"dir","size":0,"download_url":null,"html_url":"https://github.com/RetroAppleJS/RetroAppleJS.github.io/tree/main/disks/dev%20toolkits"},{"name":"fdraw","path":"disks/fdraw","type":"dir","size":0,"download_url":null,"html_url":"https://github.com/RetroAppleJS/RetroAppleJS.github.io/tree/main/disks/fdraw"}],"arg":{"id":"softwareCat","owner":"RetroAppleJS","repo":"RetroAppleJS.github.io","basepath":"disks","path":"disks","ref":"main"}},"https://api.github.com/repos/RetroAppleJS/RetroAppleJS.github.io/contents/disks/Merlin?ref=main":{"list":[{"name":"Merlin Assembler (early version, 40-column, DOS 3.3) side A.dsk","path":"disks/Merlin/Merlin Assembler (early version, 40-column, DOS 3.3) side A.dsk","type":"file","size":143360,"download_url":"https://raw.githubusercontent.com/RetroAppleJS/RetroAppleJS.github.io/main/disks/Merlin/Merlin%20Assembler%20(early%20version%2C%2040-column%2C%20DOS%203.3)%20side%20A.dsk","html_url":"https://github.com/RetroAppleJS/RetroAppleJS.github.io/blob/main/disks/Merlin/Merlin%20Assembler%20(early%20version,%2040-column,%20DOS%203.3)%20side%20A.dsk"},{"name":"Merlin Assembler (early version, 40-column, DOS 3.3) side B.dsk","path":"disks/Merlin/Merlin Assembler (early version, 40-column, DOS 3.3) side B.dsk","type":"file","size":143360,"download_url":"https://raw.githubusercontent.com/RetroAppleJS/RetroAppleJS.github.io/main/disks/Merlin/Merlin%20Assembler%20(early%20version%2C%2040-column%2C%20DOS%203.3)%20side%20B.dsk","html_url":"https://github.com/RetroAppleJS/RetroAppleJS.github.io/blob/main/disks/Merlin/Merlin%20Assembler%20(early%20version,%2040-column,%20DOS%203.3)%20side%20B.dsk"}],"arg":{"id":"softwareCat","owner":"RetroAppleJS","repo":"RetroAppleJS.github.io","basepath":"disks","path":"disks/Merlin","ref":"main"}},"https://api.github.com/repos/RetroAppleJS/RetroAppleJS.github.io/contents/disks/fdraw?ref=main":{"list":[{"name":"AMPERFDRAW.S","path":"disks/fdraw/AMPERFDRAW.S","type":"file","size":14661,"download_url":"https://raw.githubusercontent.com/RetroAppleJS/RetroAppleJS.github.io/main/disks/fdraw/AMPERFDRAW.S","html_url":"https://github.com/RetroAppleJS/RetroAppleJS.github.io/blob/main/disks/fdraw/AMPERFDRAW.S"},{"name":"FDRAW.CIRCLE.S","path":"disks/fdraw/FDRAW.CIRCLE.S","type":"file","size":18112,"download_url":"https://raw.githubusercontent.com/RetroAppleJS/RetroAppleJS.github.io/main/disks/fdraw/FDRAW.CIRCLE.S","html_url":"https://github.com/RetroAppleJS/RetroAppleJS.github.io/blob/main/disks/fdraw/FDRAW.CIRCLE.S"},{"name":"FDRAW.LINE.S","path":"disks/fdraw/FDRAW.LINE.S","type":"file","size":17645,"download_url":"https://raw.githubusercontent.com/RetroAppleJS/RetroAppleJS.github.io/main/disks/fdraw/FDRAW.LINE.S","html_url":"https://github.com/RetroAppleJS/RetroAppleJS.github.io/blob/main/disks/fdraw/FDRAW.LINE.S"},{"name":"FDRAW.S","path":"disks/fdraw/FDRAW.S","type":"file","size":22195,"download_url":"https://raw.githubusercontent.com/RetroAppleJS/RetroAppleJS.github.io/main/disks/fdraw/FDRAW.S","html_url":"https://github.com/RetroAppleJS/RetroAppleJS.github.io/blob/main/disks/fdraw/FDRAW.S"},{"name":"FDRAW.TABLES.S","path":"disks/fdraw/FDRAW.TABLES.S","type":"file","size":9598,"download_url":"https://raw.githubusercontent.com/RetroAppleJS/RetroAppleJS.github.io/main/disks/fdraw/FDRAW.TABLES.S","html_url":"https://github.com/RetroAppleJS/RetroAppleJS.github.io/blob/main/disks/fdraw/FDRAW.TABLES.S"},{"name":"LICENSE","path":"disks/fdraw/LICENSE","type":"file","size":11358,"download_url":"https://raw.githubusercontent.com/RetroAppleJS/RetroAppleJS.github.io/main/disks/fdraw/LICENSE","html_url":"https://github.com/RetroAppleJS/RetroAppleJS.github.io/blob/main/disks/fdraw/LICENSE"},{"name":"README.md","path":"disks/fdraw/README.md","type":"file","size":2149,"download_url":"https://raw.githubusercontent.com/RetroAppleJS/RetroAppleJS.github.io/main/disks/fdraw/README.md","html_url":"https://github.com/RetroAppleJS/RetroAppleJS.github.io/blob/main/disks/fdraw/README.md"},{"name":"docs","path":"disks/fdraw/docs","type":"dir","size":0,"download_url":null,"html_url":"https://github.com/RetroAppleJS/RetroAppleJS.github.io/tree/main/disks/fdraw/docs"},{"name":"fdrawdemo.do","path":"disks/fdraw/fdrawdemo.do","type":"file","size":143360,"download_url":"https://raw.githubusercontent.com/RetroAppleJS/RetroAppleJS.github.io/main/disks/fdraw/fdrawdemo.do","html_url":"https://github.com/RetroAppleJS/RetroAppleJS.github.io/blob/main/disks/fdraw/fdrawdemo.do"}],"arg":{"id":"softwareCat","owner":"RetroAppleJS","repo":"RetroAppleJS.github.io","basepath":"disks","path":"disks/fdraw","ref":"main"}},"https://api.github.com/repos/RetroAppleJS/RetroAppleJS.github.io/contents/disks/fdraw/docs?ref=main":{"list":[{"name":"demos.md","path":"disks/fdraw/docs/demos.md","type":"file","size":7190,"download_url":"https://raw.githubusercontent.com/RetroAppleJS/RetroAppleJS.github.io/main/disks/fdraw/docs/demos.md","html_url":"https://github.com/RetroAppleJS/RetroAppleJS.github.io/blob/main/disks/fdraw/docs/demos.md"},{"name":"manual.md","path":"disks/fdraw/docs/manual.md","type":"file","size":49507,"download_url":"https://raw.githubusercontent.com/RetroAppleJS/RetroAppleJS.github.io/main/disks/fdraw/docs/manual.md","html_url":"https://github.com/RetroAppleJS/RetroAppleJS.github.io/blob/main/disks/fdraw/docs/manual.md"},{"name":"personal-notes.md","path":"disks/fdraw/docs/personal-notes.md","type":"file","size":11307,"download_url":"https://raw.githubusercontent.com/RetroAppleJS/RetroAppleJS.github.io/main/disks/fdraw/docs/personal-notes.md","html_url":"https://github.com/RetroAppleJS/RetroAppleJS.github.io/blob/main/disks/fdraw/docs/personal-notes.md"}],"arg":{"id":"softwareCat","owner":"RetroAppleJS","repo":"RetroAppleJS.github.io","basepath":"disks","path":"disks/fdraw/docs","ref":"main"}},"https://api.github.com/repos/RetroAppleJS/RetroAppleJS.github.io/contents/disks/dev toolkits?ref=main":{"list":[{"name":"Apple 6502 Assembler-Editor.pdf","path":"disks/dev toolkits/Apple 6502 Assembler-Editor.pdf","type":"file","size":6830006,"download_url":"https://raw.githubusercontent.com/RetroAppleJS/RetroAppleJS.github.io/main/disks/dev%20toolkits/Apple%206502%20Assembler-Editor.pdf","html_url":"https://github.com/RetroAppleJS/RetroAppleJS.github.io/blob/main/disks/dev%20toolkits/Apple%206502%20Assembler-Editor.pdf"},{"name":"AppleSoft Toolkit (EDASM).dsk","path":"disks/dev toolkits/AppleSoft Toolkit (EDASM).dsk","type":"file","size":143360,"download_url":"https://raw.githubusercontent.com/RetroAppleJS/RetroAppleJS.github.io/main/disks/dev%20toolkits/AppleSoft%20Toolkit%20(EDASM).dsk","html_url":"https://github.com/RetroAppleJS/RetroAppleJS.github.io/blob/main/disks/dev%20toolkits/AppleSoft%20Toolkit%20(EDASM).dsk"},{"name":"DOS Programmers Toolkit_A.dsk","path":"disks/dev toolkits/DOS Programmers Toolkit_A.dsk","type":"file","size":143360,"download_url":"https://raw.githubusercontent.com/RetroAppleJS/RetroAppleJS.github.io/main/disks/dev%20toolkits/DOS%20Programmers%20Toolkit_A.dsk","html_url":"https://github.com/RetroAppleJS/RetroAppleJS.github.io/blob/main/disks/dev%20toolkits/DOS%20Programmers%20Toolkit_A.dsk"},{"name":"DOS Programmers Toolkit_B.dsk","path":"disks/dev toolkits/DOS Programmers Toolkit_B.dsk","type":"file","size":143360,"download_url":"https://raw.githubusercontent.com/RetroAppleJS/RetroAppleJS.github.io/main/disks/dev%20toolkits/DOS%20Programmers%20Toolkit_B.dsk","html_url":"https://github.com/RetroAppleJS/RetroAppleJS.github.io/blob/main/disks/dev%20toolkits/DOS%20Programmers%20Toolkit_B.dsk"},{"name":"EDASM.DSK","path":"disks/dev toolkits/EDASM.DSK","type":"file","size":143360,"download_url":"https://raw.githubusercontent.com/RetroAppleJS/RetroAppleJS.github.io/main/disks/dev%20toolkits/EDASM.DSK","html_url":"https://github.com/RetroAppleJS/RetroAppleJS.github.io/blob/main/disks/dev%20toolkits/EDASM.DSK"},{"name":"edasm.txt","path":"disks/dev toolkits/edasm.txt","type":"file","size":572,"download_url":"https://raw.githubusercontent.com/RetroAppleJS/RetroAppleJS.github.io/main/disks/dev%20toolkits/edasm.txt","html_url":"https://github.com/RetroAppleJS/RetroAppleJS.github.io/blob/main/disks/dev%20toolkits/edasm.txt"}],"arg":{"id":"softwareCat","owner":"RetroAppleJS","repo":"RetroAppleJS.github.io","basepath":"disks","path":"disks/dev toolkits","ref":"main"}},"https://api.github.com/repos/RetroAppleJS/RetroAppleJS.github.io/contents/disks/Saturn-RAMSoft?ref=main":{"list":[{"name":"Apple2Online.com.url","path":"disks/Saturn-RAMSoft/Apple2Online.com.url","type":"file","size":54,"download_url":"https://raw.githubusercontent.com/RetroAppleJS/RetroAppleJS.github.io/main/disks/Saturn-RAMSoft/Apple2Online.com.url","html_url":"https://github.com/RetroAppleJS/RetroAppleJS.github.io/blob/main/disks/Saturn-RAMSoft/Apple2Online.com.url"},{"name":"Rw4Dos33v14.dsk","path":"disks/Saturn-RAMSoft/Rw4Dos33v14.dsk","type":"file","size":143360,"download_url":"https://raw.githubusercontent.com/RetroAppleJS/RetroAppleJS.github.io/main/disks/Saturn-RAMSoft/Rw4Dos33v14.dsk","html_url":"https://github.com/RetroAppleJS/RetroAppleJS.github.io/blob/main/disks/Saturn-RAMSoft/Rw4Dos33v14.dsk"},{"name":"SATURN_128KRAM-SOFT.dsk","path":"disks/Saturn-RAMSoft/SATURN_128KRAM-SOFT.dsk","type":"file","size":143360,"download_url":"https://raw.githubusercontent.com/RetroAppleJS/RetroAppleJS.github.io/main/disks/Saturn-RAMSoft/SATURN_128KRAM-SOFT.dsk","html_url":"https://github.com/RetroAppleJS/RetroAppleJS.github.io/blob/main/disks/Saturn-RAMSoft/SATURN_128KRAM-SOFT.dsk"},{"name":"SATURN_32KRAM-SOFT.dsk","path":"disks/Saturn-RAMSoft/SATURN_32KRAM-SOFT.dsk","type":"file","size":143360,"download_url":"https://raw.githubusercontent.com/RetroAppleJS/RetroAppleJS.github.io/main/disks/Saturn-RAMSoft/SATURN_32KRAM-SOFT.dsk","html_url":"https://github.com/RetroAppleJS/RetroAppleJS.github.io/blob/main/disks/Saturn-RAMSoft/SATURN_32KRAM-SOFT.dsk"},{"name":"SATURN_Basic-PSEUDO.dsk","path":"disks/Saturn-RAMSoft/SATURN_Basic-PSEUDO.dsk","type":"file","size":143360,"download_url":"https://raw.githubusercontent.com/RetroAppleJS/RetroAppleJS.github.io/main/disks/Saturn-RAMSoft/SATURN_Basic-PSEUDO.dsk","html_url":"https://github.com/RetroAppleJS/RetroAppleJS.github.io/blob/main/disks/Saturn-RAMSoft/SATURN_Basic-PSEUDO.dsk"}],"arg":{"id":"softwareCat","owner":"RetroAppleJS","repo":"RetroAppleJS.github.io","basepath":"disks","path":"disks/Saturn-RAMSoft","ref":"main"}}}
    ...
    this.surfaceMap_mark_head = function(drv)
    {
        var d = drv + 1;
        if(this.surfaceMap_headCell[drv] != null)
        {
            var old = document.getElementById(this.surfaceMap_headCell[drv]);
            if(old) old.style.outline = "";
        }
        var hw = this.state.hw[drv]; if(!hw) return;
        var track = Math.max(0,Math.min(34,hw.track));
        var sector = Math.max(0,Math.min(15,Math.floor(hw.offset / (6656/16))));
        var id = "surfaceMap_D"+d+"_"+track+"_"+sector;
        var el = document.getElementById(id);
        if(el) el.style.outline = "2px solid #fff";
        this.surfaceMap_headCell[drv] = id;
    };
