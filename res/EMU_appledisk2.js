...
function AppleDisk2()
{
    ...
    this.read = function(addr) 
    {
        ...
        if (addr < 0x08) 
        {
            ...
            switch (addr) {
            case MOTOR_ON:
                var oldMotor = this.state.hw[drv].motor;
                this.state.hw[drv].motor = 1;
                this.traceChange("MOTOR_ON", drv, "motor", oldMotor, 1);
                this.dN_update("MOTOR_ON");
                //if(bDebug) console.log("disk2.read() MOTOR_ON");
                break;
            case MOTOR_OFF:
                var oldMotor = this.state.hw[drv].motor;
                this.state.hw[drv].motor = 0;
                this.traceChange("MOTOR_OFF", drv, "motor", oldMotor, 0);
                this.dN_update("MOTOR_OFF");
                //if(bDebug) console.log("disk2.read() MOTOR_OFF");
                break;               
            case DRV0EN:
                ...
                this.update_logs("D1");
                //if(bDebug) console.log("disk2.read() DRV0EN (D1 enable) state.hw="+JSON.stringify(this.state.hw));
                break;
            case DRV1EN:
                var oldDrv = this.state.drv;
                ...
                this.update_logs("D2");
                //if(bDebug) console.log("disk2.read() DRV1EN (D2 enable) state.hw="+JSON.stringify(this.state.hw));
                break;
            case Q6L:
...
//setDiskData: .NIB LEN:232960 CRC32: 435A9A45
    ...
    this.setDiskData = function(dskBytes,drv)
    {
        ...
        this.state.diskData[drv-1] = nibBytes;
