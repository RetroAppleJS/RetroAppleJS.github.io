   ...
   this.ROM = new Uint8Array([ // P5A
        ...
        switch(arg.id)
        {
            case "softwareCat":
                ...
                if(document.getElementById(arg.id).innerHTML=="")   // first time. (class='appbox com_popup_frame' is the bug)
                {
                    ...
                    "<div  id='"+popup_id+"' hidden='' class='appbox com_popup_frame' style='position:absolute;left:850px;width:300px;height:250px;text-align:left;padding:0px;margin:0px'></div>";
                }
    ...
    this.getSoftwareCatRows = function(arg)
    {
        function GH_listDir(elid, owner, repo, path, ref, callback)
        {
            ref = ref || "main";
            path = path || "";
            var url = "https://api.github.com/repos/" + owner + "/" + repo + "/contents/" + path + "?ref=" + encodeURIComponent(ref);
        ...
        GH_listDir(
            ...
            function(err, list, elid)             // CALLBACK FUNCTION
            {
                ...
                var head = '<div style="margin-top:6px;">'
